	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="../../../public/test/html/index.html"><span>Metro</span></a>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone">
							...
							<ul class="dropdown-menu messages">
                            	...
                            	<li>
                                    <a href="#">
										<span class="avatar"><img src="test/img/avatar.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Dennis Ji
										     </span>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="http://127.0.0.1:9999/profile"><i class="halflings-icon user"></i> Profile</a></li>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="http://127.0.0.1:9999/dashboard"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>
						<li><a href="../../../public/test/html/messages.html"><i class="icon-envelope"></i><span class="hidden-tablet"> Messages</span></a></li>
						<li><a href="../../../public/test/html/tasks.html"><i class="icon-tasks"></i><span class="hidden-tablet"> Tasks</span></a></li>
						<li><a href="../../../public/test/html/ui.html"><i class="icon-eye-open"></i><span class="hidden-tablet"> UI Features</span></a></li>
						<li><a href="../../../public/test/html/widgets.html"><i class="icon-dashboard"></i><span class="hidden-tablet"> Widgets</span></a></li>
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">表格</span><span class="label label-important"> 3 </span></a>
							<ul>
								<li><a class="submenu" href="../../../public/test/html/submenu.html"><i class="icon-file-alt"></i><span class="hidden-tablet">阵列</span></a></li>
								<li><a class="submenu" href="../../../public/test/html/submenu2.html"><i class="icon-file-alt"></i><span class="hidden-tablet">温度</span></a></li>
								<li><a class="submenu" href="../../../public/test/html/submenu3.html"><i class="icon-file-alt"></i><span class="hidden-tablet">光照度</span></a></li>
								<li><a class="submenu" href="../../../public/test/html/submenu3.html"><i class="icon-file-alt"></i><span class="hidden-tablet">电压</span></a></li>
								<li><a class="submenu" href="../../../public/test/html/submenu3.html"><i class="icon-file-alt"></i><span class="hidden-tablet">电流</span></a></li>
								<li><a class="submenu" href="../../../public/test/html/submenu3.html"><i class="icon-file-alt"></i><span class="hidden-tablet">功率</span></a></li>
							</ul>
						</li>
						<li><a href="test/html/form.html"><i class="icon-edit"></i><span class="hidden-tablet"> Forms</span></a></li>
						...
						<li><a href="test/html/login.html"><i class="icon-lock"></i><span class="hidden-tablet"> Login Page</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
